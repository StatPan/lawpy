"""Auto-generated tests for target=dlytrm."""
...
def _make_client() -> GeneratedDlytrmClient:
    return GeneratedDlytrmClient(api_key="test_key")
...
class TestGeneratedDlytrmClient:
    ...
    def test_search_passes_params(self):
        client = _make_client()
        client._make_request = Mock(return_value=_mock_response({"result": [{"target": "val", "키워드": "val", "검색결과개수": "val"}]}))
        client.search_dlytrms(query="test")

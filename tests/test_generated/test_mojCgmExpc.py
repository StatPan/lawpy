"""Auto-generated tests for target=mojCgmExpc."""
...
def _make_client() -> GeneratedMojcgmexpcClient:
    return GeneratedMojcgmexpcClient(api_key="test_key")
...
class TestGeneratedMojcgmexpcClient:
    def test_search_returns_list_of_models(self):
        ...
        result = client.search_mojCgmExpcs()
    ...
    def test_search_passes_params(self):
        client = _make_client()
        client._make_request = Mock(return_value=_mock_response({"CgmExpc": {"cgmExpc": [{"target": "val", "키워드": "val", "section": "val"}]}}))
        client.search_mojCgmExpcs(search=1)

"""Auto-generated tests for target=school."""
...
def _make_client() -> GeneratedSchoolClient:
    return GeneratedSchoolClient(api_key="test_key")
...
class TestGeneratedSchoolClient:
    ...
    def test_search_passes_params(self):
        client = _make_client()
        client._make_request = Mock(return_value=_mock_response({"result": [{"target": "val", "키워드": "val", "section": "val"}]}))
        client.search_schools(nw=1)
        call_params = client._make_request.call_args.kwargs.get("params", client._make_request.call_args[1].get("params", {}))
        assert "nw" in call_params

    def test_detail_returns_model(self):
        client = _make_client()
        client._make_request = Mock(return_value=_mock_response({"행정규칙 일련번호": "val", "행정규칙명": "val", "행정규칙종류": "val"}))
        result = client.get_school_detail()
        assert isinstance(result, SchoolDetail)

    def test_detail_passes_params(self):
        client = _make_client()
        client._make_request = Mock(return_value=_mock_response({"행정규칙 일련번호": "val", "행정규칙명": "val", "행정규칙종류": "val"}))
        client.get_school_detail(id="1")
        call_params = client._make_request.call_args.kwargs.get("params", client._make_request.call_args[1].get("params", {}))

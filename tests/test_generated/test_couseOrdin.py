"""Auto-generated tests for target=couseOrdin."""
...
def _make_client() -> GeneratedCouseordinClient:
    return GeneratedCouseordinClient(api_key="test_key")
...
class TestGeneratedCouseordinClient:
    def test_search_returns_list_of_models(self):
        ...
        result = client.search_couseOrdins(vcode="test", lj_jo="test")
    ...
    def test_search_passes_params(self):
        client = _make_client()
        client._make_request = Mock(return_value=_mock_response({"result": [{"target": "val", "vcode": "val", "section": "val"}]}))
        client.search_couseOrdins(lj_jo="test", vcode="test")

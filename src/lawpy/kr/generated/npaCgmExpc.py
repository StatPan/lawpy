"""Auto-generated client for target=npaCgmExpc
...
class GeneratedNpacgmexpcClient(KoreanBaseClient):
    """Auto-generated client for target=npaCgmExpc.
...
# ── npaCgmExpc ──────────────────────────────────────
    def search_npaCgmExpcs(
        ...
        Returns:
            List of NpacgmexpcList instances.
            Response path: CgmExpc (item key not discovered)
        """
        params: dict = {"target": "npaCgmExpc", "type": "JSON"}
        ...
        data = self._parse_json_response(response, target="npaCgmExpc")
        ...
        if isinstance(items, dict):
            items = [items]
        return [NpacgmexpcList.model_validate(item) for item in items]
    ...
    def get_npaCgmExpc_detail(
        ...
        return NpacgmexpcDetail.model_validate(raw)

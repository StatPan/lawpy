"""Auto-generated client stubs for target=acr
Source: specs/kr/
...
class AcrClient(KoreanBaseClient):
    """Auto-generated client for target=acr."""
...
# ── acr ──────────────────────────────────────
    def search_acrs(
        ...
        """[GENERATED] 국민권익위원회 결정문 목록 조회

        Args:
        search: 검색범위 1 : 민원표시 (default) 2 : 본문검색
        ...
        sort: 정렬옵션 lasc : 민원표시 오름차순 (default) ldes : 민원표시 내림차순 dasc : 의결일 오름차순 ddes : 의결일 내림차순 nasc : 의안번호 오름차순 ndes : 의안번호 내림차순
        ...
        Note:
            This is an auto-generated stub from specs/kr/acrListGuide.json.
    ...
    def get_acr_detail(
        ...
        Note:
            This is an auto-generated stub from specs/kr/acrInfoGuide.json.
            Implement the actual xmltodict parsing logic before use.
        """
        params: dict = {
            "target": "acr",

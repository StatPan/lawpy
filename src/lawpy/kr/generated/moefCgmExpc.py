"""Auto-generated client stubs for target=moefCgmExpc
Source: specs/kr/
...
# ── moefCgmExpc ──────────────────────────────────────
    def search_moefCgmExpcs(
        ...
        query: 검색범위에서 검색을 원하는 질의 (정확한 검색을 위한 문자열 검색 query="조합")
        ...
        Note:
            This is an auto-generated stub from specs/kr/cgmExpcMoefListGuide.json.

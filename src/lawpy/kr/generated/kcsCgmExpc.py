"""Auto-generated client stubs for target=kcsCgmExpc
Source: specs/kr/
...
# ── kcsCgmExpc ──────────────────────────────────────
    def search_kcsCgmExpcs(
        ...
        query: 검색범위에서 검색을 원하는 질의 (정확한 검색을 위한 문자열 검색 query="거래명세서")
        ...
        sort: 정렬옵션 (기본 : lasc 법령해석명 오름차순) ldes 법령해석명 내림차순 dasc : 해석일자 오름차순 ddes : 해석일자 내림차순
        ...
        Note:
            This is an auto-generated stub from specs/kr/cgmExpcKcsListGuide.json.
    ...
    def get_kcsCgmExpc_detail(
        ...
        Note:
            This is an auto-generated stub from specs/kr/cgmExpcKcsInfoGuide.json.
            Implement the actual xmltodict parsing logic before use.
        """
        params: dict = {
            "target": "kcsCgmExpc",

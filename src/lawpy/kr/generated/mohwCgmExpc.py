"""Auto-generated client stubs for target=mohwCgmExpc
Source: specs/kr/
...
# ── mohwCgmExpc ──────────────────────────────────────
    def search_mohwCgmExpcs(
        ...
        query: 검색범위에서 검색을 원하는 질의 (정확한 검색을 위한 문자열 검색 query="일반음식점")
        ...
        Note:
            This is an auto-generated stub from specs/kr/cgmExpcMohwListGuide.json.
    ...
    def get_mohwCgmExpc_detail(
        ...
        Note:
            This is an auto-generated stub from specs/kr/cgmExpcMohwInfoGuide.json.
            Implement the actual xmltodict parsing logic before use.
        """
        params: dict = {
            "target": "mohwCgmExpc",

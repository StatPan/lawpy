"""Auto-generated client for target=mofaCgmExpc
...
class GeneratedMofacgmexpcClient(KoreanBaseClient):
    """Auto-generated client for target=mofaCgmExpc.
...
# ── mofaCgmExpc ──────────────────────────────────────
    def search_mofaCgmExpcs(
    ...
    ) -> list[MofacgmexpcList]:
        """[GENERATED] 외교부 법령해석 목록
        ...
        data = self._parse_json_response(response, target="mofaCgmExpc")
    ...
    def get_mofaCgmExpc_detail(
        ...
        return MofacgmexpcDetail.model_validate(raw)

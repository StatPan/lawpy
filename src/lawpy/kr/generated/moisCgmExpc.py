"""Auto-generated client stubs for target=moisCgmExpc
Source: specs/kr/
...
# ── moisCgmExpc ──────────────────────────────────────
    def search_moisCgmExpcs(
        ...
        query: 검색범위에서 검색을 원하는 질의 (정확한 검색을 위한 문자열 검색 query="재해")
        ...
        Note:
            This is an auto-generated stub from specs/kr/cgmExpcMoisListGuide.json.
    ...
    def get_moisCgmExpc_detail(
        ...
        Note:
            This is an auto-generated stub from specs/kr/cgmExpcMoisInfoGuide.json.
            Implement the actual xmltodict parsing logic before use.
        """
        params: dict = {
            "target": "moisCgmExpc",

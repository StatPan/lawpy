"""Auto-generated client for target=dlytrm
...
from lawpy.kr.generated._models_generated import DlytrmList


class GeneratedDlytrmClient(KoreanBaseClient):
    """Auto-generated client for target=dlytrm.
            ...
            for v in data.values():
                ...
                if isinstance(v, dict):
                    ...
                    if not raw:
                        raw = [v]
                    break
        return [DlytrmList.model_validate(item) for item in raw]

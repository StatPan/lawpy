"""Auto-generated client for target=meCgmExpc
...
class GeneratedMecgmexpcClient(KoreanBaseClient):
    """Auto-generated client for target=meCgmExpc.
...
# ── meCgmExpc ──────────────────────────────────────
    def search_meCgmExpcs(
        ...
        Returns:
            List of MecgmexpcList instances.
            Response path: CgmExpc (item key not discovered)
        """
        params: dict = {"target": "meCgmExpc", "type": "JSON"}
        ...
        data = self._parse_json_response(response, target="meCgmExpc")
        ...
        if isinstance(items, dict):
            items = [items]
        return [MecgmexpcList.model_validate(item) for item in items]
    ...
    def get_meCgmExpc_detail(
        ...
        return MecgmexpcDetail.model_validate(raw)

"""Auto-generated client stubs for target=okaCgmExpc
Source: specs/kr/
...
# ── okaCgmExpc ──────────────────────────────────────
    def search_okaCgmExpcs(
        ...
        query: 검색범위에서 검색을 원하는 질의 (정확한 검색을 위한 문자열 검색 query="귀환")
        ...
        Note:
            This is an auto-generated stub from specs/kr/cgmExpcOkaListGuide.json.
    ...
    def get_okaCgmExpc_detail(
        ...
        Note:
            This is an auto-generated stub from specs/kr/cgmExpcOkaInfoGuide.json.
            Implement the actual xmltodict parsing logic before use.
        """
        params: dict = {
            "target": "okaCgmExpc",

...
QUICKSTART = dedent(
    ...
    Meaning:
        ...
        local ordinance, legal terminology, legal interpretation, constitutional
        decision, administrative review decision, and treaty workflows.
...
GENERATED = dedent(
    ...
    Coverage:
        ...
        89 generated tests, and nine public wrapper targets. See
